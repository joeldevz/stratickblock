...
export default () => {
  const [menu, setMenu] = useState([
    {
      icon: (
        <svg
          class="w-6 h-6 text-gray-500 group-hover:text-gray-300 transition duration-75"
          fill="currentColor"
          viewBox="0 0 20 20"
    ...
    },
    {
      icon: (
        <svg
          class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-300 transition duration-75"
          fill="currentColor"
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
        >
  ...
  return (
    <aside
      ...
      aria-label="Sidebar"
    >
      <div class="relative flex-1 flex flex-col min-h-0 border-r border-gray-900 bg-gray-900 pt-0">
