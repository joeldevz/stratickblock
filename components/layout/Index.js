  ...
  return (
    <div>
      ...
      <div class="flex overflow-hidden bg-white pt-16">
        ...
        <div
          id="main-content"
          class="h-full w-full bg-gray-800 rounded-sm relative overflow-y-auto lg:ml-64"
        >
          <main>{children}</main>
          <footer class="bg-gray-900 md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4">
