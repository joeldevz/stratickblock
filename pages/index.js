            ...
            <div className="bg-gray-900 shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
              <div className="flex items-center justify-between mb-4">
                <div className="flex-shrink-0">
                  ...
                  <h3 className="text-base font-normal text-gray-50">
                    Sales this week
                  </h3>
                </div>
                <div className="flex items-center justify-end flex-1 text-red-500 text-base font-bold">
                  12.5%
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                      ...
                      <table className="min-w-full divide-y divide-gray-800">
                        <thead className="bg-gray-800">
                          <tr>
                            <th
                              scope="col"
                              className="p-4 text-left text-xs font-medium text-gray-300 uppercase tracking-wider"
                            >
                              Transaction
                            </th>
                            <th
            ...
            <div className="bg-gray-900 shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
              ...
              <div className="block w-full overflow-x-auto">
                <table className="items-center w-full bg-transparent border-collapse">
                  <thead>
                    <tr>
                      <th className="px-4 bg-gray-700 text-gray-300 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">
                        Top Channels
                      </th>
                      <th className="px-4 bg-gray-700 text-gray-300 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">
                        Users
                      </th>
                      <th className="px-4 bg-gray-700 text-gray-300 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px"></th>
                    </tr>
                  </thead>
