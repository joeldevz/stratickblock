      ...
      <Layout address="">
        <div class="pt-6 px-4">
          <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
            <div class="bg-gray-900 shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
              <div class="flex items-center justify-between mb-4">
                <div class="flex-shrink-0">
                  <span class="text-2xl sm:text-3xl leading-none font-bold text-white">
                    $45,385
                  </span>
                  <h3 class="text-base font-normal text-gray-50">
                    Sales this week
                  </h3>
                </div>
                    ...
                    <div class="shadow overflow-hidden sm:rounded-lg">
                      <table class="min-w-full divide-y divide-gray-800">
                        ...
                        <tbody class="bg-gray-700">
                          <tr>
                            <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-300">
                              Payment from{" "}
                            ...
                            <td class="p-4 whitespace-nowrap text-sm font-semibold text-gray-300">
                              $2300
                            </td>
                          </tr>
          ...
          <div class="grid grid-cols-1 2xl:grid-cols-2 xl:gap-4 my-4">
            <div class="bg-gray-900 shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
              <div class="flex items-center justify-between mb-4">
                <h3 class="text-xl font-bold leading-none text-white">
                  Latest Customers
                </h3>
                <a
                  href="#"
            ...
            <div class="bg-gray-900 shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
              <h3 class="text-xl leading-none font-bold text-white mb-10">
              ...
              <div class="block w-full overflow-x-auto">
                <table class="items-center w-full bg-transparent border-collapse">
                  <thead>
                    <tr>
                      <th class="px-4 bg-gray-700 text-gray-300 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">
                        Top Channels
                      </th>
                      <th class="px-4 bg-gray-700 text-gray-300 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap">
                        Users
                      </th>
                      <th class="px-4 bg-gray-700 text-gray-300 align-middle py-3 text-xs font-semibold text-left uppercase border-l-0 border-r-0 whitespace-nowrap min-w-140-px"></th>
                    </tr>
                  </thead>
